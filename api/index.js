...
const cors = corsMW({
    preflightMaxAge: 5,
    origins: ['*'],
    allowHeaders: ["Origin, Accept, Accept-Version, Content-Length, Content-MD5, Content-Type, Date, X-Api-Version, X-Response-Time, X-Requested-With, X-Requested-By, X-PINGOTHER, X-CSRF-Token, Authorization"],
    exposeHeaders: []
})
...
//     res.header("Access-Control-Allow-Headers", "Origin, Accept, Accept-Version, Content-Length, Content-MD5, Content-Type, Date, X-Api-Version, X-Response-Time, X-Requested-With, X-Requested-By, X-PINGOTHER, X-CSRF-Token, Authorization");
